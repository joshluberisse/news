...
class FinancialTimesCell: NewsCell {

    static let identifier: String = "FinancialTimesCell"
    ...
    override func config() {
        ...
        logo.layer.cornerRadius = FinancialTimesCell.logoSize.width / 2
        ...
        NSLayoutConstraint.activate([
            ...
            logo.widthAnchor.constraint(equalToConstant: FinancialTimesCell.logoSize.width),
            logo.heightAnchor.constraint(equalToConstant: FinancialTimesCell.logoSize.width),
    ...
    func load(article: Article) {
        ...
        loadLogo(urlString: article.urlToSourceLogo, size: FinancialTimesCell.logoSize)
    }
