...
class NewsViewController: UIViewController {
    ...
    var handlerFinancialTimes = FinancialTimesHandler()
    ...
    var handlerCNBCNews = CNBCNewsHandler()
    ...
    func load(articles: [Article]) {
        ...
        handlerFinancialTimes.articles = articles
        ...
        handlerCNBCNews.items = articles
...
private extension NewsViewController {
    ...
    func updateCollection(_ style: NewsViewModel.Style) {
        switch style {
        case .CNBCnews:
            viewCollection.dataSource = handlerCNBCNews
            viewCollection.delegate = handlerCNBCNews
        default:
            break
        }
    ...
    func updateTable(_ style: NewsViewModel.Style) {
        ...
        case .financialtimes:
            viewTable.dataSource = handlerFinancialTimes
            viewTable.delegate = handlerFinancialTimes
        case .cnn:
